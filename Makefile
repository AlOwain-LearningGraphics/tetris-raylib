...
build/tetris: build/tetris.o build/iVector2.o build/tetromino.o build/gameController.o
	g++ build/tetris.o build/iVector2.o build/tetromino.o build/gameController.o -Wall -o build/tetris -I/usr/local/include -L/usr/local/lib -lraylib -lm -lpthread -ldl
