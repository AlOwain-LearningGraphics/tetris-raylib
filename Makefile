...
build/tetris: build/tetris.o build/iVector2.o build/tetromino.o
	g++ build/tetris.o build/iVector2.o build/tetromino.o -Wall -o build/tetris -I/usr/local/include -L/usr/local/lib -lraylib -lm -lpthread -ldl
